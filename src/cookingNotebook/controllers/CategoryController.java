...
public class CategoryController extends FunctionsController<LogicFood>{
    @FXML
     Label topLabel;
    @FXML
	...
	public void goBack(ActionEvent e) throws IOException {
		categoryView.getScene().setRoot(popRoot());
	}
    ...
    public void init(Label label) throws SQLException {
		this.topLabel.setText(label.getText());
		this.foods.setAll(FunctionsModel.initFoodInDB());
		foods.forEach(new Consumer<LogicFood>() {
                    @Override
                    public void accept(LogicFood f) {
                        ...
                        if (topLabel.getText().equalsIgnoreCase(f.getCategory())) {
                            ...
                            food.setOnMouseClicked(event -> {
                                try {
                                    ...
                                    controller.init(FoodNameTarget);
    ...
    @Override
    public void check(LogicFood t) throws SQLException {
